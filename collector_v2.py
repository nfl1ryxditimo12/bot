...
class collector():
    ...
    def db_setting(self):
        ...
        self.engine_bot = create_engine("mysql+mysqldb://bot:" + "k8726523" + "@localhost:3306/" + db_name,
                                        encoding='utf-8')
    ...
    def test(self):
        ...
        total_data = self.api.get_total_data('005930', '20201201')
        print("total_data: !!!")
        print(total_data)

        # get_one_day_option_data : openapi클래스의 메서드
        one_data = self.api.get_one_day_option_data('005930', '20201201', 'close')
        print("one_data: !!!")
        print(one_data)
